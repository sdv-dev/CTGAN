...
# NOTE: The transformer is now changed to DataTransformer in transformer.py.
# By doing that, we can use dataframe input data and categorical column headers instead of indices.
# Conditional generator is not used here.
...
class TableganSynthesizerWOCondGen(object):
