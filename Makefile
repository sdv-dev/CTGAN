...
fix-lint: ## fix lint issues using autoflake, autopep8, and isort
	find ctgan -name '*.py' | xargs autoflake --in-place --remove-all-unused-imports --remove-unused-variables
	autopep8 --in-place --recursive --aggressive ctgan
	isort --apply --atomic --recursive ctgan
...
docs: clean-docs ## generate Sphinx HTML documentation, including API docs
	sphinx-apidoc --module-first --separate -o docs/api/ ctgan
	$(MAKE) -C docs html
